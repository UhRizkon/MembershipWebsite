...
export default function Story(props) {
  const { postModel, testimonial, overrides, ...rest } = props;
  const bannerOnClick = useNavigateAction({
    target: "_blank",
    type: "url",
    url: "https://photonotebucket-jmharold.s3.us-west-2.amazonaws.com/Hello+World+2.pdf",
  });
  return (
    <Flex
      gap="11px"
    ...
    >
      ...
      <Text
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children={`${postModel?.readtime}${" minute read"}`}
